Gem::Specification.new do |s|
    ...
    s.files = ["lib/docme.rb", "lib/docme/utils.rb", "lib/docme/page.rb", "lib/docme/block.rb", "lib/docme/DocmeCLI.rb", "lib/templates/page.erb", "lib/templates/index.erb", "lib/templates/style.erb"]
